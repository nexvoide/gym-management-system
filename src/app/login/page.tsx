...
export default async function LoginPage() {
  ...
  return <main className="auth-page">
    ...
    <section className="auth-panel"><div className="auth-card"><div className="eyebrow">Welcome back</div><h2>Sign in to Form</h2><p className="muted">Use your staff account to continue.</p><LoginForm/></div></section>
  </main>;
}
