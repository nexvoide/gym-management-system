...
import { signedMemberPhotoUrls } from "@/lib/member-photos";
import { db } from "@/db";
...
export default async function MembersPage({ searchParams }: Props) {
    ...
    const photoUrls = await signedMemberPhotoUrls(data.rows.map(member => member.profilePhotoUrl), user.gymId);
